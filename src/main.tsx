  ...
  return (
    <main className="marketing-page">
      ...
      <section className="content-page legal-page">
        ...
        <h2>広告について</h2>
        <p>
          本サービスではGoogle AdSenseなどの広告配信サービスを利用する場合があります。第三者配信事業者（Googleを含みます）は、
          利用者が本サービスや他のサイトへ過去にアクセスした情報に基づいて広告を配信するため、Cookieを使用することがあります。
          Googleの広告Cookieにより、Googleおよびそのパートナーは本サービスや他のサイトへのアクセス情報に基づいて広告を表示できます。
        </p>
        <h2>広告Cookieの管理</h2>
        <p>
          利用者は
          ...
          からパーソナライズ広告を無効にできます。また、第三者配信事業者によるCookieの利用については、各事業者の案内に従って管理できます。
        </p>
        <h2>決済について</h2>
        <p>
          有料プランを提供する場合、決済処理はStripeなどの外部決済サービス上で行います。本サービスはクレジットカード番号などの決済情報を直接保存しません。
        </p>
        <h2>お問い合わせ</h2>
  ...
  return (
    <main className="marketing-page">
      ...
      <section className="content-page legal-page">
        ...
        <h2>有料機能</h2>
        <p>Proなどの有料機能を提供する場合、価格、提供内容、決済方法、解約方法は本サービス上または決済ページ上に表示します。</p>
        <h2>免責事項</h2>
